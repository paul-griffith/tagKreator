...
@DisplayName("Deserialization Verification Tests")
class DeserializationTests : FunSpec() {
    ...
    private inline fun <reified T> assertDeserializes(resourcePath: String) {
        val stream = this::class.java.getResourceAsStream("/io/github/paulgriffith/tagkreator/model/$resourcePath.json")
